...
public enum Constants {
    ...
    PAY_MENTHOD_TYPE_5("5", "余额支付", "PAY_MENTHOD_TYPE"),
    PAY_MENTHOD_TYPE_6("6", "免支付", "PAY_MENTHOD_TYPE"),
    ...
    //订单类型
    ORDER_TYPE_1(1, "普通单", "ORDER_TYPE"),
    ORDER_TYPE_2(2, "靓号单", "ORDER_TYPE"),
    ORDER_TYPE_3(3, "竞拍单", "ORDER_TYPE"),
    ORDER_TYPE_4(4, "客服单", "ORDER_TYPE"),
    ORDER_TYPE_6(6, "接口单", "ORDER_TYPE"),
    ORDER_TYPE_5(5, "补发单", "ORDER_TYPE"),
    ORDER_TYPE_7(7, "缴费单", "ORDER_TYPE"),
    ...
    PROMOTION_PLAN_FEETYPE_8(8, "一类提成", "PROMOTION_PLAN_FEETYPE"),//(10户10单)
    PROMOTION_PLAN_FEETYPE_9(9, "二类提成", "PROMOTION_PLAN_FEETYPE"),//(100户100单)
    ...
    CONSUMER_PARTNERCHECK_3(3, "暂不审核", "CONSUMER_PARTNERCHECK"),
    ...
    SHIPMENTAPI_HK("leyu", "平台", "SHIPMENTAPI"),
    SHIPMENTAPI_EGT("egt", "E购通仓储","SHIPMENTAPI"),
    SHIPMENTAPI_HR_RECHARGE("hr_recharge", "华睿充值","SHIPMENTAPI"),
...
//    private String[] goodsTypes = new String[]{"1","2","3","4"};
    ...
    ORDERCANCELCHECK_STATUS_0(0, "初始默认", "ORDERCANCELCHECK_STATUS"),
    ORDERCANCELCHECK_STATUS_1(1, "申请取消", "ORDERCANCELCHECK_STATUS"),
    ORDERCANCELCHECK_STATUS_2(2, "审核通过", "ORDERCANCELCHECK_STATUS"),
    ORDERCANCELCHECK_STATUS_3(3, "审核不通过", "ORDERCANCELCHECK_STATUS"),

    //物流类型
    FREIGHT_TYPE_1(1, "包邮", "FREIGHT_TYPE"),
    FREIGHT_TYPE_2(2, "到付", "FREIGHT_TYPE"),
    FREIGHT_TYPE_3(3, "自定义", "FREIGHT_TYPE"),

    //身份证验证状态
    IDCARD_CHECKSTATUS_0(0, "未验证", "IDCARD_CHECKSTATUS"),
    IDCARD_CHECKSTATUS_1(1, "验证通过", "IDCARD_CHECKSTATUS"),
    IDCARD_CHECKSTATUS_2(2, "验证未通过", "IDCARD_CHECKSTATUS"),

    //开卡限制
    SIGN_LIMIT_0(0, "不限制", "SIGN_LIMIT"),
    SIGN_LIMIT_1(1, "限制", "SIGN_LIMIT"),
