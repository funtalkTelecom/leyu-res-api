...
public enum Constants {
    ...
    SELL_SOURCE_ORDER("ORDER", "采购", "SELL_SOURCE"),
    ...
    //1申请中；2待支付；3待审核；4待发货；5待签收；6已完成；7已取消
    COMMODITY_APPLY_STATUS_0(1, "申请中", "COMMODITY_APPLY_STATUS"),
    COMMODITY_APPLY_STATUS_1(2, "待支付", "COMMODITY_APPLY_STATUS"),
    COMMODITY_APPLY_STATUS_2(2, "已支付", "COMMODITY_APPLY_STATUS"),
    COMMODITY_APPLY_STATUS_3(3, "待审核", "COMMODITY_APPLY_STATUS"),
    COMMODITY_APPLY_STATUS_4(4, "待发货", "COMMODITY_APPLY_STATUS"),
    COMMODITY_APPLY_STATUS_5(5, "待签收", "COMMODITY_APPLY_STATUS"),
    COMMODITY_APPLY_STATUS_6(6, "已完成", "COMMODITY_APPLY_STATUS"),
    COMMODITY_APPLY_STATUS_7(7, "已取消", "COMMODITY_APPLY_STATUS"),
