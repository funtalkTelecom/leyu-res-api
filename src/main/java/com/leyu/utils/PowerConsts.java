...
//	SYSTEMMOUULE_USERLIST_UPPWD(90205,"修改密码",90200,1,"",3,6),
	...
	BLANKLMOUDULE(91300,"黑名单管理",90000,0,"blank/blank-query",2,8),
	BLANKLMOUDULE_QUEYR(91301,"查询",91300,1,"",3,1),
	BLANKLMOUDULE_DELETE(91303,"删除",91300,1,"",3,3),//删除
	...
	GOODSMOUDULE_COMMON_AUTOMATIC_ADD(70205,"自动上架",70200,1,"",3,5),//商品自动上架
	...
	NUMBERMOUDULE_COMMON_IMPORT_ALL(70305,"批量导入",70300,1,"",3,5),//批量导入
	NUMBERMOUDULE_COMMON_LOSE_ALL(70306,"失效",70300,1,"",3,6),//批量导入
	...
	ORDERMOUDULE_COMMON_ADJUST(70608,"调价",70600,1,"",3,8),//
	ORDERMOUDULE_COMMON_AGAIN(70609,"补发",70600,1,"",3,9),//
	ORDERMOUDULE_COMMON_CANCEL_OUT(70610,"取消已发货订单",70600,1,"",3,10),//
	ORDERMOUDULE_COMMON_PUSHSTORAGE(70611,"推送",70600,1,"",3,10),//
	ORDERMOUDULE_COMMON_DELIVERY(70612,"发货",70600,1,"",3,10),//
	ORDERMOUDULE_COMMON_LOOK_MOBILE(70613,"查看号码",70600,1,"",3,10),//
	ORDERMOUDULE_COMMON_BLANK(70614,"设置黑名单",70600,1,"",3,14),//
	ORDERMOUDULE_COMMON_CANCEL_CHECK(70615,"审核取消订单",70600,1,"",3,15),//取消订单审核
	ORDERMOUDULE_COMMON_FREE_SHIPPING(70616,"设置免邮",70600,1,"",3,16),//设置免邮
	ORDERMOUDULE_COMMON_NOTE(70617,"设置备注",70600,1,"",3,17),//设置备注
	ORDERMOUDULE_COMMON_IDENTITY_MEAL(70618,"身份和套餐信息",70600,1,"",3,18),//身份和套餐信息
	...
	MEALMOUDULE_COMMON_ADD_NUM(70105,"添加号码",70100,1,"",3,5),//设置号码对应的套餐
	...
	LOGISTICSMOUDULE(71000,"物流管理",70000,0,"logistics/logistics-query",2,12),//佣金管理
	LOGISTICSMOUDULE_QUERY(71001,"查询",71000,1,"",3,1),
	LOGISTICSMOUDULE_EDIT(71002,"编辑",71000,1,"",3,1),
	...
	CORPMODULE(71300,"商家管理",70000,0,"corp/corp-query",2,13),//商家管理
	CORPMODULE_COMMON_ADD(71301,"添加",71300,1,"",3,1),//商家添加
	CORPMODULE_COMMON_QUEYR(71302,"查询",71300,1,"",3,2),//商家查询
	CORPMODULE_COMMON_EDIT(71303,"修改",71300,1,"",3,3),//商家修改
	CORPMODULE_COMMON_DELETE(71304,"删除",71300,1,"",3,4),//商家删除

	/********************************报表管理*************************************/
	REPORTMODULE(60000,"报表管理",1,0,"",1,9),
	REPORTMODULE_ORDERLIST(60100,"订单报表",60000,0,"report/query-order",2,1),   //订单报表
	REPORTMODULE_ORDERLIST_QUERY(60101,"查询",60100,1,"",3,1),
	REPORTMODULE_KFYJJS(60200,"客服佣金结算",60000,0,"report/query-commission-settle",2,2),
	REPORTMODULE_KFYJJS_QUERY(60201,"查询",60200,1,"",3,1),
