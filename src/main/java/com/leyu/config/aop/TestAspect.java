...
public class TestAspect {
    ...
    @Pointcut(value="@annotation(com.leyu.config.annotation.NoRepeat)")
//    @Pointcut(value="execution(* com.leyu.service.*.pay*(..))")
     ...
     * @param joinPoint
     */
    //    @After(value="value="execution(* com.leyu.service.*.pay*(..))")
...
//     * @param joinPoint
//     */
//    @Before(value="execution(* com.leyu.service.*.pay*(..))")
